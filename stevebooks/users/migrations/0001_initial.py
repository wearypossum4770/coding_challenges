    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "addresses",
                    models.ManyToManyField(blank=True, to="addresses.Address"),
                ),
                (
                    "user",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(("date_of_death__lte", datetime.date(2021, 7, 8))),
        ...
        migrations.AddConstraint(
            model_name="profile",
            constraint=models.CheckConstraint(
                check=models.Q(("date_of_birth__lte", datetime.date(2021, 7, 7))),
